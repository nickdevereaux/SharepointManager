    ...
    public class ComposablePartExportProvider : ExportProvider, IDisposable
    {
        ...
        public ExportProvider SourceProvider
        {
            ...
            set
            {
                ...
                ImportEngine importEngine = new ImportEngine(this._sourceProvider);
        ...
        protected override IEnumerable<Export> GetExportsCore(ImportDefinition definition, AtomicComposition atomicComposition)
        {
            ...
            List<ComposablePart> parts = atomicComposition.GetValueAllowNull(this, this._parts);
            if (parts.Count == 0)
            {
        ...
        private List<ComposablePart> GetUpdatedPartsList(CompositionBatch batch)
        {
            ...
            List<ComposablePart> parts = this._parts.ToList(); // this copies the list
