...
namespace Microsoft.Internal {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Multiple Import and ImportMany attributes were found on member &apos;{0}&apos;. Only one such attribute may be specified..
        /// </summary>
        internal static string Discovery_MultipleImportAttributes {
            get {
                return ResourceManager.GetString("Discovery_MultipleImportAttributes", resourceCulture);
            }
        }
