...
namespace System.ComponentModel.Composition.Primitives
{
    ...
    public class ContractBasedImportDefinition : ImportDefinition
    {
        ...
        private readonly IEnumerable<string> _requiredMetadata = Enumerable.Empty<string>();
        ...
        ///     </note>
        /// </remarks>
        public virtual IEnumerable<string> RequiredMetadata
        {
        ...
        private bool MatchRequiredMatadata(ExportDefinition definition)
        {
            ...
            foreach (string metadataKey in this.RequiredMetadata)
            {
                if (!definition.Metadata.ContainsKey(metadataKey))
                {
                    return false;
                }
            }
