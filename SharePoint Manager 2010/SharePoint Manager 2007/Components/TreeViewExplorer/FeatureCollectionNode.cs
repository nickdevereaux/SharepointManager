...
namespace Keutmann.SharePointManager.Components
{
    class FeatureCollectionNode : ExplorerNodeBase
    {
        ...
        {
            this.Text = SPMLocalization.GetString("WebApplicationFeatures_Text");
            this.ToolTipText = SPMLocalization.GetString("WebApplicationFeatures_ToolTip");
            this.Name = "ApplicationFeatures";
